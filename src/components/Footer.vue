        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-6 col-12">
              <h2 class="text-white mb-lg-0"></h2>
            </div>
        ...
        <div class="row">
          <div class="col-lg-6 col-12 mb-4 pb-2">
            ...
            <ul class="site-footer-links">
              ...
              <li class="site-footer-link-item">
                <a href="#" class="site-footer-link">acerca</a>
              </li>
  
              <li class="site-footer-link-item">
                <a href="#" class="site-footer-link">Labiales</a>
              </li>
  
              <li class="site-footer-link-item">
                <a href="#" class="site-footer-link">Sombras</a>
              </li>
  
              <li class="site-footer-link-item">
                <a href="#" class="site-footer-link">Catalogo</a>
              </li>
          ...
          <div class="col-lg-3 col-md-6 col-12 mb-4 mb-lg-0">
            ...
            <p class="text-white d-flex">
              <a href="mailto:hello@company.com" class="site-footer-link">
                runCosmetics@gmail.com
              </a>
            </p>
          </div>
  
          <div class="col-lg-3 col-md-6 col-11 mb-4 mb-lg-0 mb-md-0">
            <h5 class="site-footer-title mb-3">Ubicaciones</h5>
  
            <p class="text-white d-flex mt-3 mb-2">
              Bolivia, sucre, hernando siles
            </p>
